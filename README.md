...
## Workings
### The main db assignable
The main DB assignable is the class that will store the database structure. This is the interface to the SQL generator.

When an db assignable is assigned, it will return a db assignable proxy. 